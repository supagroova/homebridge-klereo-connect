...
describe('KlereoApi', () => {
    ...
    describe('setParam', () => {
        ...
        it('should set parameter successfully and return command ID', async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith(expect.stringContaining('SetParam.php'), expect.anything());
        });
        it('should throw on failed response', async () => {
            ...
            await expect(api.setParam(17501, 'ConsigneEau', 30)).rejects.toThrow('Failed to set parameter ConsigneEau');
        });
    });
